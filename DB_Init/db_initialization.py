...
while True:
        ...
        while True:
            ...
            if year_parameter.isdigit() and len(year_parameter) == 4:
                ...
                if 2010 <= year_parameter_int < current_year:
                    ...
                    print('')
                    print(f'Income data for year(s) {year_parameter} extracted successfully!')
                    ...
                    # Add Vehicle Type ID, CAFV ID, and Utility Company ID to main dataframe 
    ...
    # Give error if user doesn't type yes or no
    else:
        print('')
